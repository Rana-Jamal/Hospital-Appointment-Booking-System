...
# # Step3: Create Fastapi application and endpoints pseudo code
...
#     # logic to cancel appointment, update/cancel row to database
...
#     # logic to schedule appointment, read rows from database
